...
public final class QLTheLoai extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtTheloai.setBackground(new java.awt.Color(167, 230, 255));
        txtTheloai.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        txtTheloai.setForeground(new java.awt.Color(5, 12, 156));
        txtTheloai.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(5, 12, 156)));
        ...
        txtMa.setBackground(new java.awt.Color(167, 230, 255));
        txtMa.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        txtMa.setForeground(new java.awt.Color(5, 12, 156));
