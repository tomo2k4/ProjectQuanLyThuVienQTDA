...
public final class QLTacGia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pnlNoidung.setBackground(new java.awt.Color(167, 230, 255));
        pnlNoidung.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(5, 12, 156), 3));
        pnlNoidung.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTentg.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        lblTentg.setForeground(new java.awt.Color(5, 12, 156));
        ...
        lblMatg.setForeground(new java.awt.Color(5, 12, 156));
        ...
        lblChuyenmon.setForeground(new java.awt.Color(5, 12, 156));
        ...
        lblGioithieu.setForeground(new java.awt.Color(5, 12, 156));
